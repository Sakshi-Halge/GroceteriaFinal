...
const url = "https://groceteriaapi.herokuapp.com/product?lprice=90&hprice=99";
...
class OfferNintyNineComponent extends Component {
  constructor(props) {
    super();
...
export default OfferNintyNineComponent;
